package techplex.core.inventory.container;
...
import techplex.core.inventory.slot.SlotAlloyFurnace;
import techplex.core.tileentity.TileEntityAlloyFurnace;

public class ContainerAlloyFurnace extends TechPlexContainer {
	...
	public ContainerAlloyFurnace(EntityPlayer player, TileEntityAlloyFurnace furnace)
	{
		...
		// result
		this.addSlotToContainer(new SlotAlloyFurnace(player, furnace, 2, 116, 35));
		// smelt2
